...
{
	{ "WIFI", "WIFI", "WIFI", NULL},
	{ "正在刷新", "正在重繪", "Refreshing", NULL},
	{ "输入密码", "輸入密碼", "Input password", NULL},
	{ "连接中...", "連接中...", "Connecting...", NULL},
	{ "请输入", "請輸入", "Please input.", NULL},
...
//----标题----//
	...
	lvgl_SheZhi_wifi_task = lvgl_task_create(lvgl_SheZhi_wifi_TaskCb, 1000, LV_TASK_PRIO_LOWEST, NULL);
